        ...
        >
          ...
          >
            <Image
              ...
              height={96}
              priority
              className="h-[72px] w-auto drop-shadow-[0_2px_10px_rgba(201,169,106,0.25)]"
            />
          </motion.div>

          <motion.div
            variants={itemVariants}
            className="mb-5 flex items-center justify-center gap-4 text-[9px] font-semibold uppercase tracking-[0.35em] text-[#A07D38]"
          >
