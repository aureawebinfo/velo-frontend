...
export default function LoginPage() {
  ...
  return (
    <motion.div
      ...
      // ELIMINADO EL CURSOR-NONE DE AQUÍ
      className="flex min-h-[100dvh] w-full bg-background text-foreground overflow-hidden"
    >
      ...
      <div className="relative flex w-full flex-col items-center justify-center px-6 py-12 lg:w-1/2 lg:px-12">
        ...
        <button
          ...
          aria-label="Volver"
          // ELIMINADO EL CURSOR-NONE DE AQUÍ
          className="group absolute left-6 top-6 lg:left-10 lg:top-10 flex h-10 w-10 items-center justify-center border border-accent/20 bg-transparent text-accent transition-all duration-300 hover:bg-accent/10 rounded-sm"
        >
          <ArrowLeft
        ...
        >
          ...
          <motion.div
            variants={itemVariants}
            className="mb-6 flex items-center justify-center gap-4 text-[10px] font-medium uppercase tracking-[0.4em] text-accent"
          >
          ...
          <motion.div variants={itemVariants}>
            <form onSubmit={handleEmailLogin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  // ELIMINADO EL CURSOR-NONE DE AQUÍ
                  className="w-full rounded-sm border border-white/10 bg-black/20 px-4 py-3 text-sm text-foreground placeholder-muted/30 transition-colors focus:border-accent/80 focus:bg-black/40 focus:outline-none"
                  required
                />
              </div>
              <div>
              ...
              <button
                ...
                disabled={loading}
                // ELIMINADO EL CURSOR-NONE DE AQUÍ
                className="mt-4 w-full rounded-sm bg-accent py-3.5 text-[11px] font-semibold uppercase tracking-[0.2em] text-background transition-colors hover:bg-accent/90 disabled:opacity-50"
              >
            ...
            <button
              ...
              className="group flex w-full items-center justify-center gap-3 rounded-sm border border-white/10 bg-transparent py-3 transition-all duration-300 hover:border-accent/40 hover:bg-white/[0.02]"
            >
              <svg
            ...
            <div className="mt-6 text-center">
              <p className="text-xs text-muted">
                ...
                <button
                  ...
                  className="ml-1 text-accent transition-colors hover:text-accent/70"
                >
                  Crear cuenta
                </button>
              </p>
