...
export interface SoftAuroraProps {
  ...
  /* Props agregadas para resolver el error de TypeScript */
  maxDpr?: number;
  renderScale?: number;
...
export default function SoftAurora({
  ...
  useEffect(() => {
    ...
    function resize() {
      const width = container.offsetWidth * renderScale;
      const height = container.offsetHeight * renderScale;
