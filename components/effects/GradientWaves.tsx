...
const GradientWaves = ({
  ...
  useEffect(() => {
    ...
    // 1. Envolvemos la creación en un try/catch
    try {
      ...
      console.warn("No se pudo inicializar WebGL (límite de contextos o no soportado):", error);
      return; // Aborta silenciosamente sin romper la página
    }

    const gl = renderer.gl;
    if (!gl) return; // Verificación extra por seguridad
